...
<header>
        <div class="container">
          <nav id="navigation">
            <a href="#" class="logo has-text-white" data-aos="fade-right">Tayy Eb Chaudhary</a>
            <a aria-label="mobile menu" class="nav-toggle">
              ...
              <ul class="menu-left">
                ...
                <li><button className="button is-small has-background-primary has-text-white">Login</button></li>
             <li><i class="fa fa-th" aria-hidden="true"></i>
</li>
              </ul>
          </nav>
        </div>
      <div className="text">
      <h1 className="is-size-1 has-text-white has-text-centered" style={{paddingTop:"150px"}} data-aos="fade-down">Stunning free images & Vedios free stock
</h1>
<p className="has-text-white is-size-5 has-text-centered" data-aos="fade-left">Over 1.612062 million+ high quality stock images and videos shared by our talented community.

</p><div>

  <input type="text" placeholder="Search Any Images And Vedio"/>
  <select>
  ...
  {/* <i className="fa fa-search"></i> */}
       <div className="links">
         <p className="has-text-centered">Popular Images
         
         <a>Buniess,</a><a>Wallpaper,</a><a>Vedios,</a><a>Movies,</a><a>Gallery</a><a>Product</a><a>About Info</a><a></a><a></a>
         </p>
       </div>
</div>
      </div>
 ...
 <div class="translate_wrapper has-background-link">
  ...
  <div class="more_lang">
    ...
    <div class="lang" data-value="pt">
      ...
      <span class="lang-txt">Português<span className="has-text-white"> (BR)</span></span>      
    </div> 
    
    <div class="lang" data-value="ar">
      <img src="https://image.flaticon.com/icons/svg/299/299815.svg"/>
      <span class="lang-txt">العربية <span className="has-text-white"> (SA)</span></span>      
    </div> 
  </div>
</div> 
{/* End  */}
